...
#define __K1OM_XPU_MMFW_BASENAME "RASMM.elf"


#define L1OM_XPU_MAINTENANCE_MODE_FW_PATH \
	"/lib/firmware/mic/" __L1OM_XPU_MMFW_BASENAME
#define K1OM_XPU_MAINTENANCE_MODE_FW_PATH \
	"/lib/firmware/mic/" __K1OM_XPU_MMFW_BASENAME
...
int get_adapter_memsize(uint8_t *mmio_va, uint32_t *adapter_mem_size);
